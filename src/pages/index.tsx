  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless dining with Restaurant Booking Engine - the ultimate platform for table reservations and restaurant management. Simplifying dining, one reservation at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless dining with Restaurant Booking Engine - the ultimate platform for table reservations and restaurant management. Simplifying dining, one reservation at a time.`}
            </Text>
            <Box
